...
import { Banknote, CalendarCheck2, ChevronLeft, ChevronRight, Folder, Brain, List, Stethoscope,Clock, Syringe, Settings } from 'lucide-react';
import Link from 'next/link';
import Image from 'next/image';
import logoImg from '../../../../../public/logo-liga.png'
        ...
        {isCollapsed && (
          <nav className='flex flex-col gap-1 overflow-hidden'>
            ...
            <SidebarLink
              ...
              label="Disponibilidades de horarios"
              pathname={pathname}
              isCollapsed={isCollapsed}
